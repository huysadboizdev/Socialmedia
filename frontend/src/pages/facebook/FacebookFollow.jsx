...
const FacebookFollow = () => {
  ...
  const servers = [
    { 
      id: 'sv1', 
      name: 'Sv1', 
      label: 'Theo Dõi FB Việt | ⚡ Nhanh ⚡ | Lên Sẽ Lên Phát Một #Update Hoàn Thành Cực Nhanh 500k/DAy', 
      price: 7.06, 
      status: 'Hoạt động',
      statusType: 'success'
    },
    { 
      id: 'sv2', 
      name: 'Sv2', 
      label: 'Theo Dõi FB Việt | ⚡ Nhanh ⚡ | Cài Là Lên Luôn', 
      price: 2.34, 
      status: 'Bảo trì',
      statusType: 'error'
    },
    { 
      id: 'sv3', 
      name: 'Sv3', 
      label: 'Theo Dõi FB | Tốc Độ Ổn | Ngày Chạy 3K', 
      price: 1.85, 
      status: 'Bảo trì',
      statusType: 'error'
    },
                  ...
                  <div key={server.id} className="flex items-center gap-3">
                    ...
                    <label htmlFor={server.id} className="flex flex-wrap items-center gap-2 cursor-pointer select-none text-sm">
                      ...
                      <span className={`px-2 py-0.5 rounded text-xs text-white ${
                        server.statusType === 'success' ? 'bg-green-500' : 'bg-red-500'
                      }`}>
                        {server.status}
                      </span>
                    </label>
