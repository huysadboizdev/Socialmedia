...
const FacebookLike = () => {
  ...
  const servers = [
    { id: 'sv1', name: 'Sv1', label: 'Like 👍 | Nhanh', price: 13.5, status: 'Hoạt động', color: 'orange' },
    { id: 'sv2', name: 'Sv2', label: 'Tim ❤️ | Nhanh', price: 13.5, status: 'Hoạt động', color: 'orange' },
    { id: 'sv3', name: 'Sv3', label: 'Care 😆 | Nhanh', price: 13.5, status: 'Hoạt động', color: 'orange' },
    { id: 'sv4', name: 'Sv4', label: 'Buồn 😢 | Nhanh', price: 13.5, status: 'Hoạt động', color: 'orange' },
    { id: 'sv5', name: 'Sv5', label: 'HaHa 🤣 | Nhanh', price: 13.5, status: 'Hoạt động', color: 'orange' },
    { id: 'sv6', name: 'Sv6', label: 'Wow 😮 | Nhanh', price: 13.5, status: 'Hoạt động', color: 'orange' },
    { id: 'sv7', name: 'Sv7', label: 'Cáu 😡 | Nhanh', price: 13.5, status: 'Hoạt động', color: 'orange' },
  ];
