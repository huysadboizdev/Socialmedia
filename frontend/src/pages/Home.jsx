        ...
        <div className="max-w-[1600px] mx-auto p-4 md:p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex items-center gap-4">
              <div className="size-12 rounded-full bg-pink-50 flex items-center justify-center text-pink-500">
            ...
            <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex items-center gap-4">
              ...
              <div>
                <div className="text-xl font-bold text-gray-800">0</div>
                <div className="text-xs text-gray-500">Tổng nạp</div>
              </div>
            </div>
            ...
            <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex items-center gap-4">
              ...
              <div>
                <div className="text-xl font-bold text-gray-800">0 USD</div>
                <div className="text-xs text-gray-500">Nạp tháng</div>
              </div>
            </div>
             ...
             <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex items-center gap-4">
              ...
              <div>
                <div className="text-xl font-bold text-gray-800">Thành viên</div>
                <div className="text-xs text-gray-500">Cấp bậc</div>
              </div>
            </div>
          </div>
