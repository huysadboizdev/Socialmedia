...
const TiktokFollow = () => {
  ...
  const servers = [
    { id: 'sv1', name: 'Sv1', label: 'Follow Việt | ⚡ Nhanh ⚡ | Xịn Nhất | Bảo Hành 7 Ngày', price: 28.7, status: 'Hoạt động', color: 'orange' },
    { id: 'sv2', name: 'Sv2', label: 'Follow Việt | ⚡ Nhanh ⚡ | Cài Là Lên Luôn 20k - 100k/Day', price: 17.8, status: 'Hoạt động', color: 'orange' },
    { id: 'sv3', name: 'Sv3', label: 'Follow Việt | ⚡ Nhanh ⚡ | Tốc Độ : 3k - 7k Trong 24h', price: 11.7, status: 'Hoạt động', color: 'orange' },
    { id: 'sv4', name: 'Sv4', label: 'Follow Việt | Tốc Độ Ổn | Giá Rẻ Nhất Hiện Tại', price: 7.47, status: 'Hoạt động', color: 'orange' },
    { id: 'sv5', name: 'Sv5', label: 'Follow Tây | Tốc Độ Ổn | 3k - 5k/ 24 Giờ', price: 6.44, status: 'Hoạt động', color: 'orange' },
  ];
  ...
  const handleSubmit = () => {
    if (!formData.link) {
      toast.error('Vui lòng nhập Link hoặc UID profile');
      return;
    }
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl p-6 shadow-sm border border-slate-100 dark:border-slate-800">
            ...
            <div className="mb-8">
              ...
              <input
                ...
                placeholder="Nhập link profile tiktok..."
              />
            </div>
