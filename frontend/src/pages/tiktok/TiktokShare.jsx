...
const TiktokShare = () => {
  ...
  const servers = [
    { id: 'sv1', name: 'Sv1', label: 'Share Video | ⚡ Nhanh ⚡ | Cài Là Lên Luôn', price: 2.6, status: 'Hoạt động', color: 'orange' },
    { id: 'sv3', name: 'Sv3', label: 'Share Video | ⚡ Nhanh ⚡ | Cài Là Lên Luôn', price: 4.8, status: 'Hoạt động', color: 'orange' },
  ];
