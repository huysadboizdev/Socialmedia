...
const InstagramFollow = () => {
  ...
  const servers = [
    { id: 'sv1', name: 'Sv1', label: 'Follow Tây | ⚡ Nhanh ⚡ | Tụt Ít Nhất Hiện Tại', price: 23.7, status: 'Hoạt động', color: 'orange' },
    { id: 'sv2', name: 'Sv2', label: 'Follow Tây | ⚡ Nhanh ⚡ | Rẻ Nhất Hiện Tại', price: 9.8, status: 'Hoạt động', color: 'orange' },
    { id: 'sv3', name: 'Sv3', label: 'Follow Việt | ⚡ Nhanh ⚡ | Ưu Tiên Sử Dụng', price: 85.5, status: 'Hoạt động', color: 'orange' },
    { id: 'sv4', name: 'Sv4', label: 'Follow Việt | ⚡ Tốc Ổn ⚡ | Lên Từ Từ', price: 18.7, status: 'Hoạt động', color: 'orange' },
  ];
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl p-6 shadow-sm border border-slate-100 dark:border-slate-800">
            ...
            <div className="mb-8">
              ...
              <input
                ...
                placeholder="Nhập link profile instagram..."
              />
            </div>
