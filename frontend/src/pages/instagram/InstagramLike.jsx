...
const InstagramLike = () => {
  ...
  const servers = [
    { id: 'sv1', name: 'Sv1', label: 'Tim Tây | ⚡ Nhanh ⚡ | Cài Là Lên Luôn', price: 4.5, status: 'Hoạt động', color: 'orange' },
    { id: 'sv2', name: 'Sv2', label: 'Tim Việt | ⚡ Nhanh ⚡ | Lên Từ Từ', price: 12.3, status: 'Hoạt động', color: 'orange' },
  ];
